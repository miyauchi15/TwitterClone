...
<body class="home profile test-center">
<div class="container">
<?php include_once('../views/common/side.php'); ?>
    ...
    <div class="profile-area">
        <div class="top">
        <div class="user"><img src="\twitterclone\views\css\img\img_uploaded\user\sample-person.jpg" alt=""></div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="user">
                                        <img src="\twitterclone\views\css\img\img_uploaded\user\sample-person.jpg" alt="">
                                    </div>
                                    <div class="mb-3">
