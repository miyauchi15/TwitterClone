...
<body class="signup text-center">
    <main class="form-signup">
        <form action="sign-up.php" method="post">
            <img src="<?php echo HOME_URL; ?>views/css/img/logo-white.svg" alt=" " class="logo-white">
            <h1>アカウントを作る</h1>
            ...
            <input type="emain" class="form-control" name="email" placeholder="メールアドレス" maxlength="254" required>
